...
class TextureLoader
{
	...
	public void LoadTexture()
	{
		...
		if (File.Exists(_presetsDefs))
			OpenNijiiroRW.Skin.Game_SkinScenes = ConfigManager.GetConfig<DBSkinPreset.SkinPreset>(_presetsDefs);
		else
			OpenNijiiroRW.Skin.Game_SkinScenes = new DBSkinPreset.SkinPreset();
		...
		if (Effects_Hit_Explosion != null) Effects_Hit_Explosion.b加算合成 = OpenNijiiroRW.Skin.Game_Effect_HitExplosion_AddBlend;
		Effects_Hit_Explosion_Big = TxC(GAME + EFFECTS + @$"Hit{Path.DirectorySeparatorChar}Explosion_Big.png");
		if (Effects_Hit_Explosion_Big != null) Effects_Hit_Explosion_Big.b加算合成 = OpenNijiiroRW.Skin.Game_Effect_HitExplosionBig_AddBlend;
		Effects_Hit_FireWorks = TxC(GAME + EFFECTS + @$"Hit{Path.DirectorySeparatorChar}FireWorks.png");
		if (Effects_Hit_FireWorks != null) Effects_Hit_FireWorks.b加算合成 = OpenNijiiroRW.Skin.Game_Effect_FireWorks_AddBlend;

		Effects_Hit_Bomb = TxCAf(GAME + EFFECTS + @$"Hit{Path.DirectorySeparatorChar}Bomb.png");


		Effects_Fire = TxC(GAME + EFFECTS + @$"Fire.png");
		if (Effects_Fire != null) Effects_Fire.b加算合成 = OpenNijiiroRW.Skin.Game_Effect_Fire_AddBlend;

		Effects_Rainbow = TxC(GAME + EFFECTS + @$"Rainbow.png");

		Effects_GoGoSplash = TxC(GAME + EFFECTS + @$"GoGoSplash.png");
		if (Effects_GoGoSplash != null) Effects_GoGoSplash.b加算合成 = OpenNijiiroRW.Skin.Game_Effect_GoGoSplash_AddBlend;
		...
		var puchicharaDirs = System.IO.Directory.GetDirectories(OpenNijiiroRW.strEXEのあるフォルダ + GLOBAL + PUCHICHARA);
		OpenNijiiroRW.Skin.Puchichara_Ptn = puchicharaDirs.Length;
		...
		OpenNijiiroRW.Skin.Game_Tower_Ptn = towerDirectories.Length;
		OpenNijiiroRW.Skin.Game_Tower_Names = new string[OpenNijiiroRW.Skin.Game_Tower_Ptn];
		for (int i = 0; i < OpenNijiiroRW.Skin.Game_Tower_Ptn; i++)
			OpenNijiiroRW.Skin.Game_Tower_Names[i] = new DirectoryInfo(towerDirectories[i]).Name;
		Tower_Top = new CTexture[OpenNijiiroRW.Skin.Game_Tower_Ptn];
		Tower_Base = new CTexture[OpenNijiiroRW.Skin.Game_Tower_Ptn][];
		Tower_Deco = new CTexture[OpenNijiiroRW.Skin.Game_Tower_Ptn][];
		...
		for (int i = 0; i < OpenNijiiroRW.Skin.Game_Tower_Ptn; i++)
		{
			...
			Tower_Top[i] = TxC(GAME + TOWER + TOWERFLOOR + OpenNijiiroRW.Skin.Game_Tower_Names[i] + @$"{Path.DirectorySeparatorChar}Top.png");
		...
		OpenNijiiroRW.Skin.Game_Tower_Ptn_Result = OpenNijiiroRW.t連番画像の枚数を数える(CSkin.Path(BASE + TOWERRESULT + @$"Tower{Path.DirectorySeparatorChar}"));
		TowerResult_Tower = new CTexture[OpenNijiiroRW.Skin.Game_Tower_Ptn_Result];
		...
		var charaDirs = System.IO.Directory.GetDirectories(OpenNijiiroRW.strEXEのあるフォルダ + GLOBAL + CHARACTERS);
		OpenNijiiroRW.Skin.Characters_Ptn = charaDirs.Length;

		Characters_Heya_Preview = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn];
		Characters_Heya_Render = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn];
		Characters_Result_Clear_1P = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn];
		Characters_Result_Failed_1P = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn];
		Characters_Result_Clear_2P = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn];
		Characters_Result_Failed_2P = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn];
		Characters = new CCharacter[OpenNijiiroRW.Skin.Characters_Ptn];

		Characters_Normal = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Normal_Missed = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Normal_MissedDown = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Normal_Cleared = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Normal_Maxed = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_MissIn = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_MissDownIn = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_GoGoTime = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_GoGoTime_Maxed = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_10Combo = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_10Combo_Clear = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_10Combo_Maxed = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_GoGoStart = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_GoGoStart_Clear = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_GoGoStart_Maxed = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Become_Cleared = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Become_Maxed = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_SoulOut = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_ClearOut = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Return = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Balloon_Breaking = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Balloon_Broke = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Balloon_Miss = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Kusudama_Idle = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Kusudama_Breaking = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Kusudama_Broke = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Kusudama_Miss = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Title_Entry = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Title_Normal = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Result_Clear = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Result_Failed = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Result_Failed_In = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Result_Normal = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Menu_Loop = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Menu_Start = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Menu_Select = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Menu_Wait = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Tower_Standing = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Tower_Climbing = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Tower_Running = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Tower_Clear = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Tower_Fail = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Tower_Standing_Tired = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Tower_Climbing_Tired = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Tower_Running_Tired = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];
		Characters_Tower_Clear_Tired = new CTexture[OpenNijiiroRW.Skin.Characters_Ptn][];

		OpenNijiiroRW.Skin.Characters_DirName = new string[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Normal_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Normal_Missed_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Normal_MissedDown_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Normal_Cleared_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Normal_Maxed_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_MissIn_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_MissDownIn_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_GoGoTime_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_GoGoTime_Maxed_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_10Combo_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_10Combo_Clear_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_10Combo_Maxed_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_GoGoStart_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_GoGoStart_Clear_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_GoGoStart_Maxed_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Become_Cleared_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Become_Maxed_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_SoulOut_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_ClearOut_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Return_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Balloon_Breaking_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Balloon_Broke_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Balloon_Miss_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Kusudama_Idle_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Kusudama_Breaking_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Kusudama_Broke_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Kusudama_Miss_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Title_Entry_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Title_Normal_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Result_Clear_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Result_Failed_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Result_Failed_In_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Result_Normal_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Menu_Loop_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Menu_Start_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Menu_Select_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Menu_Wait_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Tower_Standing_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Tower_Climbing_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Tower_Running_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Tower_Clear_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Tower_Fail_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Tower_Standing_Tired_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Tower_Climbing_Tired_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Tower_Running_Tired_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Tower_Clear_Tired_Ptn = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Tower_Clear_IsLooping = new bool[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Tower_Clear_Tired_IsLooping = new bool[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Tower_Fail_IsLooping = new bool[OpenNijiiroRW.Skin.Characters_Ptn];

		OpenNijiiroRW.Skin.Characters_Resolution = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Heya_Render_Offset = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_UseResult1P = new bool[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Menu_Offset = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Result_Offset = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_X = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Y = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_4P = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_5P = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_X_AI = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Y_AI = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Balloon_X = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Balloon_Y = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Balloon_4P = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Balloon_5P = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Kusudama_X = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Kusudama_Y = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_Normal = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_10Combo = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_10Combo_Clear = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_10ComboMax = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_Miss = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_MissDown = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_ClearIn = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_Clear = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_ClearMax = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_MissIn = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_MissDownIn = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_GoGoStart = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_GoGoStart_Clear = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_GoGoStartMax = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_GoGo = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_GoGoMax = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_SoulIn = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_SoulOut = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_ClearOut = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		OpenNijiiroRW.Skin.Characters_Motion_Return = new int[OpenNijiiroRW.Skin.Characters_Ptn][];
		/*
        ...
        */
		OpenNijiiroRW.Skin.Characters_Beat_Normal = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_Miss = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_MissDown = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_Clear = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_GoGo = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_10Combo = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_10Combo_Clear = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_10ComboMax = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_ClearIn = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_ClearMax = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_MissIn = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_MissDownIn = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_GoGoStart = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_GoGoStart_Clear = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_GoGoStartMax = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_GoGoMax = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_SoulIn = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_SoulOut = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_ClearOut = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_Return = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_Tower_Standing = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_Tower_Clear = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_Tower_Fail = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_Tower_Standing_Tired = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Beat_Tower_Clear_Tired = new float[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Balloon_Timer = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Balloon_Delay = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Balloon_FadeOut = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Title_Entry_AnimationDuration = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Title_Normal_AnimationDuration = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Menu_Loop_AnimationDuration = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Menu_Select_AnimationDuration = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Menu_Start_AnimationDuration = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Menu_Wait_AnimationDuration = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Result_Normal_AnimationDuration = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		OpenNijiiroRW.Skin.Characters_Result_Clear_AnimationDuration = new int[OpenNijiiroRW.Skin.Characters_Ptn];
		...
		for (int i = 0; i < OpenNijiiroRW.Skin.Characters_Ptn; i++)
		{
			...
			Characters_Result_Failed_1P[i] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Result_Failed_1P.png");
			Characters_Result_Clear_2P[i] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Result_Clear_2P.png");
			Characters_Result_Failed_2P[i] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Result_Failed_2P.png");

			OpenNijiiroRW.Skin.Characters_Resolution[i] = new int[] { 1280, 720 };
			OpenNijiiroRW.Skin.Characters_Heya_Render_Offset[i] = new int[] { 0, 0 };
			OpenNijiiroRW.Skin.Characters_UseResult1P[i] = false;


			var _str = "";
			OpenNijiiroRW.Skin.LoadSkinConfigFromFile(charaDirs[i] + @$"{Path.DirectorySeparatorChar}CharaConfig.txt", ref _str);
	...
	public void ReloadCharacter(int old, int newC, int player, bool primary = false)
	{
		...
		if (old >= 0 &&
			(OpenNijiiroRW.SaveFileInstances[0].data.Character != old || player == 0) &&
			...
			(OpenNijiiroRW.SaveFileInstances[4].data.Character != old || player == 4))
		{
			...
			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Menu_Loop_Ptn[i]; j++)
				Characters_Menu_Loop[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Menu_Start_Ptn[i]; j++)
				Characters_Menu_Start[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Menu_Select_Ptn[i]; j++)
				Characters_Menu_Select[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Menu_Wait_Ptn[i]; j++)
				Characters_Menu_Wait[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Result_Normal_Ptn[i]; j++)
				Characters_Result_Normal[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Result_Failed_In_Ptn[i]; j++)
				Characters_Result_Failed_In[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Result_Failed_Ptn[i]; j++)
				Characters_Result_Failed[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Result_Clear_Ptn[i]; j++)
				Characters_Result_Clear[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Title_Normal_Ptn[i]; j++)
				Characters_Title_Normal[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Title_Entry_Ptn[i]; j++)
				Characters_Title_Entry[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Normal_Ptn[i]; j++)
				Characters_Normal[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Normal_Missed_Ptn[i]; j++)
				Characters_Normal_Missed[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Normal_MissedDown_Ptn[i]; j++)
				Characters_Normal_MissedDown[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Normal_Cleared_Ptn[i]; j++)
				Characters_Normal_Cleared[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Normal_Maxed_Ptn[i]; j++)
				Characters_Normal_Maxed[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_MissIn_Ptn[i]; j++)
				Characters_MissIn[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_MissDownIn_Ptn[i]; j++)
				Characters_MissDownIn[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_GoGoTime_Ptn[i]; j++)
				Characters_GoGoTime[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_GoGoTime_Maxed_Ptn[i]; j++)
				Characters_GoGoTime_Maxed[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_GoGoStart_Ptn[i]; j++)
				Characters_GoGoStart[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_GoGoStart_Clear_Ptn[i]; j++)
				Characters_GoGoStart_Clear[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_GoGoStart_Maxed_Ptn[i]; j++)
				Characters_GoGoStart_Maxed[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_10Combo_Ptn[i]; j++)
				Characters_10Combo[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_10Combo_Clear_Ptn[i]; j++)
				Characters_10Combo_Clear[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_10Combo_Maxed_Ptn[i]; j++)
				Characters_10Combo_Maxed[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Become_Cleared_Ptn[i]; j++)
				Characters_Become_Cleared[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Become_Maxed_Ptn[i]; j++)
				Characters_Become_Maxed[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_SoulOut_Ptn[i]; j++)
				Characters_SoulOut[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_ClearOut_Ptn[i]; j++)
				Characters_ClearOut[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Return_Ptn[i]; j++)
				Characters_Return[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Balloon_Breaking_Ptn[i]; j++)
				Characters_Balloon_Breaking[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Balloon_Broke_Ptn[i]; j++)
				Characters_Balloon_Broke[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Balloon_Miss_Ptn[i]; j++)
				Characters_Balloon_Miss[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Kusudama_Idle_Ptn[i]; j++)
				Characters_Kusudama_Idle[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Kusudama_Breaking_Ptn[i]; j++)
				Characters_Kusudama_Breaking[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Kusudama_Broke_Ptn[i]; j++)
				Characters_Kusudama_Broke[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Kusudama_Miss_Ptn[i]; j++)
				Characters_Kusudama_Miss[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Standing_Ptn[i]; j++)
				Characters_Tower_Standing[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Climbing_Ptn[i]; j++)
				Characters_Tower_Climbing[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Running_Ptn[i]; j++)
				Characters_Tower_Running[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Clear_Ptn[i]; j++)
				Characters_Tower_Clear[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Fail_Ptn[i]; j++)
				Characters_Tower_Fail[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Standing_Tired_Ptn[i]; j++)
				Characters_Tower_Standing_Tired[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Climbing_Tired_Ptn[i]; j++)
				Characters_Tower_Climbing_Tired[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Running_Tired_Ptn[i]; j++)
				Characters_Tower_Running_Tired[i][j]?.Dispose();

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Clear_Tired_Ptn[i]; j++)
				Characters_Tower_Clear_Tired[i][j]?.Dispose();
			#endregion
		}

		string charaPath = OpenNijiiroRW.strEXEのあるフォルダ + GLOBAL + CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[newC];

		if ((newC >= 0 &&
			 OpenNijiiroRW.SaveFileInstances[0].data.Character != newC &&
			 ...
			 OpenNijiiroRW.SaveFileInstances[4].data.Character != newC) || primary)
		{
			...
			OpenNijiiroRW.Skin.Characters_Normal_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Normal{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Normal_Missed_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Miss{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Normal_MissedDown_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}MissDown{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_MissIn_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}MissIn{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_MissDownIn_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}MissDownIn{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Normal_Cleared_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Clear{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Normal_Maxed_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Clear_Max{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_GoGoTime_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}GoGo{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_GoGoTime_Maxed_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}GoGo_Max{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_10Combo_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}10combo{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_10Combo_Clear_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}10combo_Clear{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_10Combo_Maxed_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}10combo_Max{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_GoGoStart_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}GoGoStart{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_GoGoStart_Clear_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}GoGoStart_Clear{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_GoGoStart_Maxed_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}GoGoStart_Max{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Become_Cleared_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Clearin{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Become_Maxed_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Soulin{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_SoulOut_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}SoulOut{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_ClearOut_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}ClearOut{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Return_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Return{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Balloon_Breaking_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Balloon_Breaking{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Balloon_Broke_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Balloon_Broke{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Balloon_Miss_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Balloon_Miss{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Kusudama_Idle_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Kusudama_Idle{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Kusudama_Breaking_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Kusudama_Breaking{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Kusudama_Broke_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Kusudama_Broke{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Kusudama_Miss_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Kusudama_Miss{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Title_Entry_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Title_Entry{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Title_Normal_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Title_Normal{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Menu_Loop_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Menu_Loop{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Menu_Select_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Menu_Select{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Menu_Start_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Menu_Start{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Menu_Wait_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Menu_Wait{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Result_Clear_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Result_Clear{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Result_Failed_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Result_Failed{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Result_Failed_In_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Result_Failed_In{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Result_Normal_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Result_Normal{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Tower_Standing_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Standing{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Tower_Climbing_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Climbing{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Tower_Running_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Running{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Tower_Clear_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Clear{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Tower_Fail_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Fail{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Tower_Standing_Tired_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Standing_Tired{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Tower_Climbing_Tired_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Climbing_Tired{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Tower_Running_Tired_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Running_Tired{Path.DirectorySeparatorChar}");
			OpenNijiiroRW.Skin.Characters_Tower_Clear_Tired_Ptn[i] = OpenNijiiroRW.t連番画像の枚数を数える(charaPath + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Clear_Tired{Path.DirectorySeparatorChar}");

			Characters_Normal[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Normal_Ptn[i]];
			Characters_Normal_Missed[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Normal_Missed_Ptn[i]];
			Characters_Normal_MissedDown[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Normal_MissedDown_Ptn[i]];
			Characters_Normal_Cleared[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Normal_Cleared_Ptn[i]];
			Characters_Normal_Maxed[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Normal_Maxed_Ptn[i]];
			Characters_MissIn[i] = new CTexture[OpenNijiiroRW.Skin.Characters_MissIn_Ptn[i]];
			Characters_MissDownIn[i] = new CTexture[OpenNijiiroRW.Skin.Characters_MissDownIn_Ptn[i]];
			Characters_GoGoTime[i] = new CTexture[OpenNijiiroRW.Skin.Characters_GoGoTime_Ptn[i]];
			Characters_GoGoTime_Maxed[i] = new CTexture[OpenNijiiroRW.Skin.Characters_GoGoTime_Maxed_Ptn[i]];
			Characters_10Combo[i] = new CTexture[OpenNijiiroRW.Skin.Characters_10Combo_Ptn[i]];
			Characters_10Combo_Clear[i] = new CTexture[OpenNijiiroRW.Skin.Characters_10Combo_Clear_Ptn[i]];
			Characters_10Combo_Maxed[i] = new CTexture[OpenNijiiroRW.Skin.Characters_10Combo_Maxed_Ptn[i]];
			Characters_GoGoStart[i] = new CTexture[OpenNijiiroRW.Skin.Characters_GoGoStart_Ptn[i]];
			Characters_GoGoStart_Clear[i] = new CTexture[OpenNijiiroRW.Skin.Characters_GoGoStart_Clear_Ptn[i]];
			Characters_GoGoStart_Maxed[i] = new CTexture[OpenNijiiroRW.Skin.Characters_GoGoStart_Maxed_Ptn[i]];
			Characters_Become_Cleared[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Become_Cleared_Ptn[i]];
			Characters_Become_Maxed[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Become_Maxed_Ptn[i]];
			Characters_SoulOut[i] = new CTexture[OpenNijiiroRW.Skin.Characters_SoulOut_Ptn[i]];
			Characters_ClearOut[i] = new CTexture[OpenNijiiroRW.Skin.Characters_ClearOut_Ptn[i]];
			Characters_Return[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Return_Ptn[i]];
			Characters_Balloon_Breaking[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Balloon_Breaking_Ptn[i]];
			Characters_Balloon_Broke[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Balloon_Broke_Ptn[i]];
			Characters_Balloon_Miss[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Balloon_Miss_Ptn[i]];
			Characters_Kusudama_Idle[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Kusudama_Idle_Ptn[i]];
			Characters_Kusudama_Breaking[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Kusudama_Breaking_Ptn[i]];
			Characters_Kusudama_Broke[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Kusudama_Broke_Ptn[i]];
			Characters_Kusudama_Miss[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Kusudama_Miss_Ptn[i]];
			Characters_Title_Entry[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Title_Entry_Ptn[i]];
			Characters_Title_Normal[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Title_Normal_Ptn[i]];
			Characters_Result_Clear[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Result_Clear_Ptn[i]];
			Characters_Result_Failed[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Result_Failed_Ptn[i]];
			Characters_Result_Failed_In[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Result_Failed_In_Ptn[i]];
			Characters_Result_Normal[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Result_Normal_Ptn[i]];
			Characters_Menu_Loop[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Menu_Loop_Ptn[i]];
			Characters_Menu_Start[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Menu_Start_Ptn[i]];
			Characters_Menu_Select[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Menu_Select_Ptn[i]];
			Characters_Menu_Wait[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Menu_Wait_Ptn[i]];
			Characters_Tower_Standing[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Tower_Standing_Ptn[i]];
			Characters_Tower_Climbing[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Tower_Climbing_Ptn[i]];
			Characters_Tower_Running[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Tower_Running_Ptn[i]];
			Characters_Tower_Clear[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Tower_Clear_Ptn[i]];
			Characters_Tower_Fail[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Tower_Fail_Ptn[i]];
			Characters_Tower_Standing_Tired[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Tower_Standing_Tired_Ptn[i]];
			Characters_Tower_Climbing_Tired[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Tower_Climbing_Tired_Ptn[i]];
			Characters_Tower_Running_Tired[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Tower_Running_Tired_Ptn[i]];
			Characters_Tower_Clear_Tired[i] = new CTexture[OpenNijiiroRW.Skin.Characters_Tower_Clear_Tired_Ptn[i]];
			...
			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Menu_Loop_Ptn[i]; j++)
				Characters_Menu_Loop[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Menu_Loop{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Menu_Select_Ptn[i]; j++)
				Characters_Menu_Select[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Menu_Select{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Menu_Start_Ptn[i]; j++)
				Characters_Menu_Start[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Menu_Start{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Menu_Wait_Ptn[i]; j++)
				Characters_Menu_Wait[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Menu_Wait{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Result_Normal_Ptn[i]; j++)
				Characters_Result_Normal[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Result_Normal{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Result_Failed_In_Ptn[i]; j++)
				Characters_Result_Failed_In[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Result_Failed_In{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Result_Failed_Ptn[i]; j++)
				Characters_Result_Failed[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Result_Failed{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Result_Clear_Ptn[i]; j++)
				Characters_Result_Clear[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Result_Clear{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Title_Normal_Ptn[i]; j++)
				Characters_Title_Normal[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Title_Normal{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Title_Entry_Ptn[i]; j++)
				Characters_Title_Entry[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Title_Entry{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Normal_Ptn[i]; j++)
				Characters_Normal[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Normal{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Normal_Missed_Ptn[i]; j++)
				Characters_Normal_Missed[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Miss{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Normal_MissedDown_Ptn[i]; j++)
				Characters_Normal_MissedDown[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}MissDown{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Normal_Cleared_Ptn[i]; j++)
				Characters_Normal_Cleared[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Clear{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Normal_Maxed_Ptn[i]; j++)
				Characters_Normal_Maxed[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Clear_Max{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_MissIn_Ptn[i]; j++)
				Characters_MissIn[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}MissIn{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_MissDownIn_Ptn[i]; j++)
				Characters_MissDownIn[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}MissDownIn{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_GoGoTime_Ptn[i]; j++)
				Characters_GoGoTime[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}GoGo{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_GoGoTime_Maxed_Ptn[i]; j++)
				Characters_GoGoTime_Maxed[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}GoGo_Max{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_GoGoStart_Ptn[i]; j++)
				Characters_GoGoStart[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}GoGoStart{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_GoGoStart_Clear_Ptn[i]; j++)
				Characters_GoGoStart_Clear[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}GoGoStart_Clear{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_GoGoStart_Maxed_Ptn[i]; j++)
				Characters_GoGoStart_Maxed[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}GoGoStart_Max{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_10Combo_Ptn[i]; j++)
				Characters_10Combo[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}10combo{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_10Combo_Clear_Ptn[i]; j++)
				Characters_10Combo_Clear[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}10combo_Clear{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_10Combo_Maxed_Ptn[i]; j++)
				Characters_10Combo_Maxed[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}10combo_Max{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Become_Cleared_Ptn[i]; j++)
				Characters_Become_Cleared[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Clearin{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Become_Maxed_Ptn[i]; j++)
				Characters_Become_Maxed[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Soulin{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_SoulOut_Ptn[i]; j++)
				Characters_SoulOut[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Soulout{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_ClearOut_Ptn[i]; j++)
				Characters_ClearOut[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Clearout{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Return_Ptn[i]; j++)
				Characters_Return[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Return{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Balloon_Breaking_Ptn[i]; j++)
				Characters_Balloon_Breaking[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Balloon_Breaking{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Balloon_Broke_Ptn[i]; j++)
				Characters_Balloon_Broke[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Balloon_Broke{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Balloon_Miss_Ptn[i]; j++)
				Characters_Balloon_Miss[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Balloon_Miss{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Kusudama_Idle_Ptn[i]; j++)
				Characters_Kusudama_Idle[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Kusudama_Idle{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Kusudama_Breaking_Ptn[i]; j++)
				Characters_Kusudama_Breaking[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Kusudama_Breaking{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Kusudama_Broke_Ptn[i]; j++)
				Characters_Kusudama_Broke[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Kusudama_Broke{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Kusudama_Miss_Ptn[i]; j++)
				Characters_Kusudama_Miss[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Kusudama_Miss{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Standing_Ptn[i]; j++)
				Characters_Tower_Standing[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Standing{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Climbing_Ptn[i]; j++)
				Characters_Tower_Climbing[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Climbing{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Running_Ptn[i]; j++)
				Characters_Tower_Running[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Running{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Clear_Ptn[i]; j++)
				Characters_Tower_Clear[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Clear{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Fail_Ptn[i]; j++)
				Characters_Tower_Fail[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Fail{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Standing_Tired_Ptn[i]; j++)
				Characters_Tower_Standing_Tired[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Standing_Tired{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Climbing_Tired_Ptn[i]; j++)
				Characters_Tower_Climbing_Tired[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Climbing_Tired{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Running_Tired_Ptn[i]; j++)
				Characters_Tower_Running_Tired[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Running_Tired{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");

			for (int j = 0; j < OpenNijiiroRW.Skin.Characters_Tower_Clear_Tired_Ptn[i]; j++)
				Characters_Tower_Clear_Tired[i][j] = TxCGlobal(CHARACTERS + OpenNijiiroRW.Skin.Characters_DirName[i] + @$"{Path.DirectorySeparatorChar}Tower_Char{Path.DirectorySeparatorChar}Clear_Tired{Path.DirectorySeparatorChar}" + j.ToString() + @$".png");
			...
			OpenNijiiroRW.Skin.Characters_Menu_Offset[i] = new int[] { 0, 0 };
			OpenNijiiroRW.Skin.Characters_Result_Offset[i] = new int[] { 0, 0 };
			OpenNijiiroRW.Skin.Characters_X[i] = new int[] { 0, 0 };
			OpenNijiiroRW.Skin.Characters_Y[i] = new int[] { 0, 537 };
			OpenNijiiroRW.Skin.Characters_4P[i] = new int[] { 165, 68 };
			OpenNijiiroRW.Skin.Characters_5P[i] = new int[] { 165, 40 };
			OpenNijiiroRW.Skin.Characters_X_AI[i] = new int[] { 472, 602 };
			OpenNijiiroRW.Skin.Characters_Y_AI[i] = new int[] { 152, 152 };
			OpenNijiiroRW.Skin.Characters_Balloon_X[i] = new int[] { 240, 240, 0, 0 };
			OpenNijiiroRW.Skin.Characters_Balloon_Y[i] = new int[] { 0, 297, 0, 0 };
			OpenNijiiroRW.Skin.Characters_Balloon_4P[i] = new int[] { 0, -176 };
			OpenNijiiroRW.Skin.Characters_Balloon_5P[i] = new int[] { 0, -168 };
			OpenNijiiroRW.Skin.Characters_Kusudama_X[i] = new int[] { 290, 690, 90, 890, 490 };
			OpenNijiiroRW.Skin.Characters_Kusudama_Y[i] = new int[] { 420, 420, 420, 420, 420 };
			OpenNijiiroRW.Skin.Characters_Motion_Normal[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_Normal_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_10Combo[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_10Combo_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_10Combo_Clear[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_10Combo_Clear_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_10ComboMax[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_10Combo_Maxed_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_Miss[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_Normal_Missed_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_MissDown[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_Normal_MissedDown_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_ClearIn[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_Become_Cleared_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_Clear[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_Normal_Cleared_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_ClearMax[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_Normal_Maxed_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_MissIn[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_MissIn_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_MissDownIn[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_MissDownIn_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_GoGoStart[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_GoGoStart_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_GoGoStart_Clear[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_GoGoStart_Clear_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_GoGoStartMax[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_GoGoStart_Maxed_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_GoGo[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_GoGoTime_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_GoGoMax[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_GoGoTime_Maxed_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_SoulIn[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_Become_Maxed_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_SoulOut[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_SoulOut_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_ClearOut[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_ClearOut_Ptn[i]);
			OpenNijiiroRW.Skin.Characters_Motion_Return[i] = CreateNumberedArrayFromInt(OpenNijiiroRW.Skin.Characters_Return_Ptn[i]);
			/*
            ...
            */
			OpenNijiiroRW.Skin.Characters_Beat_Normal[i] = 1;
			OpenNijiiroRW.Skin.Characters_Beat_Miss[i] = 1;
			OpenNijiiroRW.Skin.Characters_Beat_MissDown[i] = 1;
			OpenNijiiroRW.Skin.Characters_Beat_Clear[i] = 2;
			OpenNijiiroRW.Skin.Characters_Beat_GoGo[i] = 2;
			OpenNijiiroRW.Skin.Characters_Beat_MissIn[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_MissDownIn[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_10Combo[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_10Combo_Clear[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_10ComboMax[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_ClearIn[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_ClearMax[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_GoGoStart[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_GoGoStart_Clear[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_GoGoStartMax[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_GoGoMax[i] = 2;
			OpenNijiiroRW.Skin.Characters_Beat_SoulIn[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_SoulOut[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_ClearOut[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_Return[i] = 1.5f;
			OpenNijiiroRW.Skin.Characters_Beat_Tower_Standing[i] = 1;
			OpenNijiiroRW.Skin.Characters_Beat_Tower_Clear[i] = 1;
			OpenNijiiroRW.Skin.Characters_Beat_Tower_Fail[i] = 1;
			OpenNijiiroRW.Skin.Characters_Beat_Tower_Standing_Tired[i] = 1;
			OpenNijiiroRW.Skin.Characters_Beat_Tower_Clear_Tired[i] = 1;
			OpenNijiiroRW.Skin.Characters_Balloon_Timer[i] = 28;
			OpenNijiiroRW.Skin.Characters_Balloon_Delay[i] = 500;
			OpenNijiiroRW.Skin.Characters_Balloon_FadeOut[i] = 84;
			OpenNijiiroRW.Skin.Characters_Title_Entry_AnimationDuration[i] = 1000;
			OpenNijiiroRW.Skin.Characters_Title_Normal_AnimationDuration[i] = 1000;
			OpenNijiiroRW.Skin.Characters_Menu_Loop_AnimationDuration[i] = 1000;
			OpenNijiiroRW.Skin.Characters_Menu_Select_AnimationDuration[i] = 1000;
			OpenNijiiroRW.Skin.Characters_Menu_Start_AnimationDuration[i] = 1000;
			OpenNijiiroRW.Skin.Characters_Menu_Wait_AnimationDuration[i] = 1000;
			OpenNijiiroRW.Skin.Characters_Result_Normal_AnimationDuration[i] = 1000;
			OpenNijiiroRW.Skin.Characters_Result_Clear_AnimationDuration[i] = 1000;
			OpenNijiiroRW.Skin.Characters_Result_Failed_In_AnimationDuration[i] = 1000;
			OpenNijiiroRW.Skin.Characters_Result_Failed_AnimationDuration[i] = 1000;

			#endregion

			var _str = "";
			OpenNijiiroRW.Skin.LoadSkinConfigFromFile(charaPath + @$"{Path.DirectorySeparatorChar}CharaConfig.txt", ref _str);
