		...
		for (int i = 0; i < OpenNijiiroRW.ConfigIni.nPlayerCount; i++) {
			...
			if (Directory.Exists(currentDir)) {
				foreach (var item in Directory.GetFiles(currentDir)) {
					...
					comboVoice.soundComboVoice = OpenNijiiroRW.SoundManager.tCreateSound(item, ESoundGroup.Voice);
					/*
                    ...
                    */
					comboVoice.soundComboVoice.SoundPosition = OpenNijiiroRW.ConfigIni.nPanning[OpenNijiiroRW.ConfigIni.nPlayerCount - 1][i];
