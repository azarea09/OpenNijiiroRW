...
internal class CActImplDancer : CActivity
{
	...
	public override void Activate()
	{
		...
		this.ar踊り子モーション番号 = CConversion.StringToIntArray(OpenNijiiroRW.Skin.Game_Dancer_Motion);
	...
	private void LoadDancerConifg(string dancerPath)
	{
		...
		OpenNijiiroRW.Skin.Game_Dancer_X = new int[] { 640, 430, 856, 215, 1070 };
		OpenNijiiroRW.Skin.Game_Dancer_Y = new int[] { 500, 500, 500, 500, 500 };
		nDancerCount = 5;
		nDancerInInterval = 0;
