...
class CStageCutScene : CStage
{
	...
	public override void Activate()
	{
		...
		if (this.cutScenes == null)
			this.cutScenes = [];
		//this.LoadCutScenes(OpenNijiiroRW.rPreviousStage);
	...
	public void Resume()
	{
		...
		SoundManager.PlayTimer.NowTimeMs = OpenNijiiroRW.Timer.NowTimeMs;
	...
	private static CSound? CreateSound(string? filepathAVI)
	{
		...
		try
		{
			...
			OpenNijiiroRW.SongGainController.Set(CSound.DefaultSongVol, loudnessMetadata, sound);
