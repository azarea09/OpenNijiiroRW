...
internal class CActConfigList : CActivity {
	...
	public void t項目リストの設定_System(bool refresh = true) {
		...
		this.iSystemLanguage = new CItemList(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_LANGUAGE"), CItemList.EPanelType.Normal, CLangManager.langToInt(OpenNijiiroRW.ConfigIni.sLang),
		...
		this.iTaikoPlayerCount = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_PLAYERCOUNT"), 1, 5, OpenNijiiroRW.ConfigIni.nPlayerCount,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_PLAYERCOUNT_DESC"));
		this.list項目リスト.Add(this.iTaikoPlayerCount);

		this.iDanTowerHide = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_HIDEDANTOWER"), OpenNijiiroRW.ConfigIni.bDanTowerHide,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_HIDEDANTOWER_DESC"));
		this.list項目リスト.Add(this.iDanTowerHide);

		this.iCommonPlaySpeed = new CItemInteger(CLangManager.LangInstance.GetString("MOD_SONGSPEED"), 5, 400, OpenNijiiroRW.ConfigIni.nSongSpeed,
			CLangManager.LangInstance.GetString("SETTINGS_MOD_SONGSPEED_DESC"));
		this.list項目リスト.Add(this.iCommonPlaySpeed);

		this.iSystemTimeStretch = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_TIMESTRETCH"), OpenNijiiroRW.ConfigIni.bTimeStretch,
		...
		this.iSystemFullscreen = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_FULLSCREEN"), OpenNijiiroRW.ConfigIni.bFullScreen,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_FULLSCREEN_DESC"));
		this.list項目リスト.Add(this.iSystemFullscreen);

		this.iSystemRandomFromSubBox = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_RANDOMSUBFOLDER"), OpenNijiiroRW.ConfigIni.bIncludeSubfoldersOnRandomSelect,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_RANDOMSUBFOLDER_DESC"));
		this.list項目リスト.Add(this.iSystemRandomFromSubBox);

		this.iSystemVSyncWait = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_VSYNC"), OpenNijiiroRW.ConfigIni.bEnableVSync,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_VSYNC_DESC"));
		this.list項目リスト.Add(this.iSystemVSyncWait);

		this.iSystemAVI = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_BGMOVIE"), OpenNijiiroRW.ConfigIni.bEnableAVI,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_BGMOVIE_DESC"));
		this.list項目リスト.Add(this.iSystemAVI);

		this.iSystemAVIDisplayMode = new CItemList(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_BGMOVIEDISPLAY"), CItemList.EPanelType.Normal, (int)OpenNijiiroRW.ConfigIni.eClipDispType,
		...
		this.iSystemBGA = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_BGA"), OpenNijiiroRW.ConfigIni.bEnableBGA,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_BGA_DESC"));
		this.list項目リスト.Add(this.iSystemBGA);

		this.iSystemPreviewSoundWait = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SONGPREVIEWBUFFER"), 0, 0x2710, OpenNijiiroRW.ConfigIni.nMsWaitPreviewSoundFromSongSelected,
		...
		this.iSystemPreviewImageWait = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_IMAGEPREVIEWBUFFER"), 0, 0x2710, OpenNijiiroRW.ConfigIni.nMsWaitPreviewImageFromSongSelected,
		...
		this.iSystemDebugInfo = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DEBUGMODE"), OpenNijiiroRW.ConfigIni.bDisplayDebugInfo,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DEBUGMODE_DESC"));
		this.list項目リスト.Add(this.iSystemDebugInfo);

		this.iSystemBGAlpha = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_LANEOPACITY"), 0, 0xff, OpenNijiiroRW.ConfigIni.nBackgroundTransparency,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_LANEOPACITY_DESC"));
		this.list項目リスト.Add(this.iSystemBGAlpha);

		this.iSystemBGMSound = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SONGPLAYBACK"), OpenNijiiroRW.ConfigIni.bBGMPlayVoiceSound,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SONGPLAYBACK_DESC"));
		this.list項目リスト.Add(this.iSystemBGMSound);

		this.iSystemApplySongVol = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_USESONGVOL"), OpenNijiiroRW.ConfigIni.ApplySongVol,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_USESONGVOL_DESC"));
		this.list項目リスト.Add(this.iSystemApplySongVol);

		this.iSystemSoundEffectLevel = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SEVOL"), CSound.MinimumGroupLevel, CSound.MaximumGroupLevel, OpenNijiiroRW.ConfigIni.SoundEffectLevel,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SEVOL_DESC"));
		this.list項目リスト.Add(this.iSystemSoundEffectLevel);

		this.iSystemVoiceLevel = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_VOICEVOL"), CSound.MinimumGroupLevel, CSound.MaximumGroupLevel, OpenNijiiroRW.ConfigIni.VoiceLevel,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_VOICEVOL_DESC"));
		this.list項目リスト.Add(this.iSystemVoiceLevel);

		this.iSystemSongPreviewLevel = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SONGPREVIEWVOL"), CSound.MinimumGroupLevel, CSound.MaximumGroupLevel, OpenNijiiroRW.ConfigIni.SongPreviewLevel,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SONGPREVIEWVOL_DESC"));
		this.list項目リスト.Add(this.iSystemSongPreviewLevel);

		this.iSystemSongPlaybackLevel = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SONGVOL"), CSound.MinimumGroupLevel, CSound.MaximumGroupLevel, OpenNijiiroRW.ConfigIni.SongPlaybackLevel,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SONGVOL_DESC"));
		this.list項目リスト.Add(this.iSystemSongPlaybackLevel);

		this.iSystemKeyboardSoundLevelIncrement = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_VOLINCREMENT"), 1, 20, OpenNijiiroRW.ConfigIni.KeyboardSoundLevelIncrement,
		...
		this.MusicPreTimeMs = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SONGPLAYBACKBUFFER"), 0, 10000, OpenNijiiroRW.ConfigIni.MusicPreTimeMs,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SONGPLAYBACKBUFFER_DESC"));
		this.list項目リスト.Add(this.MusicPreTimeMs);

		this.iSystemAutoResultCapture = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_AUTOSCREENSHOT"), OpenNijiiroRW.ConfigIni.bIsAutoResultCapture,
		...
		SendDiscordPlayingInformation = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISCORDRPC"),
			OpenNijiiroRW.ConfigIni.SendDiscordPlayingInformation,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISCORDRPC_DESC"));
		list項目リスト.Add(SendDiscordPlayingInformation);

		this.iSystemBufferedInput = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_BUFFEREDINPUT"), OpenNijiiroRW.ConfigIni.bBufferedInputs,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_BUFFEREDINPUT_DESC"));
		this.list項目リスト.Add(this.iSystemBufferedInput);
		this.iLogOutputLog = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_LOG"), OpenNijiiroRW.ConfigIni.bOutputLogs,
		...
		this.iSystemBassBufferSizeMs = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_BASSBUFFER"), 0, 99999, OpenNijiiroRW.ConfigIni.nBassBufferSizeMs,
		...
		if (OperatingSystem.IsWindows()) {
			...
			this.iSystemASIODevice = new CItemList(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_ASIOPLAYBACK"), CItemList.EPanelType.Normal, OpenNijiiroRW.ConfigIni.nASIODevice,
		...
		this.iSystemSoundTimerType = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_OSTIMER"), OpenNijiiroRW.ConfigIni.bUseOSTimer,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_OSTIMER_DESC"));
		this.list項目リスト.Add(this.iSystemSoundTimerType);

		ShowChara = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISPLAYCHARA"), OpenNijiiroRW.ConfigIni.ShowChara,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISPLAYCHARA_DESC"));
		this.list項目リスト.Add(ShowChara);

		ShowDancer = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISPLAYDANCER"), OpenNijiiroRW.ConfigIni.ShowDancer,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISPLAYDANCER_DESC"));
		this.list項目リスト.Add(ShowDancer);

		ShowMob = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISPLAYMOB"), OpenNijiiroRW.ConfigIni.ShowMob,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISPLAYMOB_DESC"));
		this.list項目リスト.Add(ShowMob);

		ShowRunner = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISPLAYRUNNER"), OpenNijiiroRW.ConfigIni.ShowRunner,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISPLAYRUNNER_DESC"));
		this.list項目リスト.Add(ShowRunner);

		ShowFooter = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISPLAYFOOTER"), OpenNijiiroRW.ConfigIni.ShowFooter,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISPLAYFOOTER_DESC"));
		this.list項目リスト.Add(ShowFooter);

		FastRender = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_FASTRENDER"), OpenNijiiroRW.ConfigIni.FastRender,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_FASTRENDER_DESC"));
		this.list項目リスト.Add(FastRender);

		ShowPuchiChara = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISPLAYPUCHI"), OpenNijiiroRW.ConfigIni.ShowPuchiChara,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_DISPLAYPUCHI_DESC"));
		this.list項目リスト.Add(ShowPuchiChara);

		SimpleMode = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SIMPLEMODE"), OpenNijiiroRW.ConfigIni.SimpleMode,
			CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_SIMPLEMODE_DESC"));
		this.list項目リスト.Add(SimpleMode);

		ASyncTextureLoad = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_SYSTEM_TEXTUREASYNC"), OpenNijiiroRW.ConfigIni.ASyncTextureLoad,
...
#if DEBUG
		this.debugImGui = new CItemToggle("[DEBUG ONLY] Show ImGui Debug Window", OpenNijiiroRW.ConfigIni.DEBUG_bShowImgui);
	...
	public void t項目リストの設定_Drums() {
		...
		this.iRollsPerSec = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_GAME_AUTOROLL"), 0, 1000, OpenNijiiroRW.ConfigIni.nRollsPerSec,
			CLangManager.LangInstance.GetString("SETTINGS_GAME_AUTOROLL_DESC"));
		this.list項目リスト.Add(this.iRollsPerSec);

		this.iAILevel = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_GAME_AILEVEL"), 1, 10, OpenNijiiroRW.ConfigIni.nDefaultAILevel,
			CLangManager.LangInstance.GetString("SETTINGS_GAME_AILEVEL_DESC"));
		this.list項目リスト.Add(this.iAILevel);

		this.iSystemRisky = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_GAME_BADCOUNT"), 0, 10, OpenNijiiroRW.ConfigIni.nRisky,
			CLangManager.LangInstance.GetString("SETTINGS_GAME_BADCOUNT_DESC"));
		this.list項目リスト.Add(this.iSystemRisky);

		this.iTaikoNoInfo = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_GAME_NOINFO"), OpenNijiiroRW.ConfigIni.bNoInfo,
			CLangManager.LangInstance.GetString("SETTINGS_GAME_NOINFO_DESC"));
		this.list項目リスト.Add(this.iTaikoNoInfo);

		this.iDrumsTight = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_GAME_NOTELOCK"), OpenNijiiroRW.ConfigIni.bTight,
			CLangManager.LangInstance.GetString("SETTINGS_GAME_NOTELOCK_DESC"));
		this.list項目リスト.Add(this.iDrumsTight);

		this.iSystemMinComboDrums = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_GAME_COMBODISPLAY"), 1, 0x1869f, OpenNijiiroRW.ConfigIni.nMinDisplayedCombo.Drums,
			CLangManager.LangInstance.GetString("SETTINGS_GAME_COMBODISPLAY_DESC"));
		this.list項目リスト.Add(this.iSystemMinComboDrums);

		this.iGlobalOffsetMs = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_GAME_GLOBALOFFSET"), -9999, 9999, OpenNijiiroRW.ConfigIni.nGlobalOffsetMs,
			CLangManager.LangInstance.GetString("SETTINGS_GAME_GLOBALOFFSET_DESC"));
		this.list項目リスト.Add(this.iGlobalOffsetMs);

		this.iTaikoDefaultCourse = new CItemList(CLangManager.LangInstance.GetString("SETTINGS_GAME_DEFAULTDIFF"), CItemBase.EPanelType.Normal, OpenNijiiroRW.ConfigIni.nDefaultCourse,
		...
		this.iTaikoScoreMode = new CItemList(CLangManager.LangInstance.GetString("SETTINGS_GAME_SCOREMODE"), CItemBase.EPanelType.Normal, OpenNijiiroRW.ConfigIni.nScoreMode,
		...
		this.ShinuchiMode = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_GAME_SHINUCHI"), OpenNijiiroRW.ConfigIni.ShinuchiMode, CItemBase.EPanelType.Normal,
		...
		this.iTaikoBranchGuide = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_GAME_BRANCHGUIDE"), OpenNijiiroRW.ConfigIni.bBranchGuide,
			CLangManager.LangInstance.GetString("SETTINGS_GAME_BRANCHGUIDE_DESC"));
		this.list項目リスト.Add(this.iTaikoBranchGuide);

		this.iTaikoBranchAnime = new CItemList(CLangManager.LangInstance.GetString("SETTINGS_GAME_BRANCHANIME"), CItemBase.EPanelType.Normal, OpenNijiiroRW.ConfigIni.nBranchAnime,
		...
		this.iTaikoGameMode = new CItemList(CLangManager.LangInstance.GetString("SETTINGS_GAME_SURVIVAL"), CItemBase.EPanelType.Normal, (int)OpenNijiiroRW.ConfigIni.eGameMode,
		...
		this.iTaikoBigNotesJudge = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_GAME_BIGNOTEJUDGE"), OpenNijiiroRW.ConfigIni.bJudgeBigNotes,
			CLangManager.LangInstance.GetString("SETTINGS_GAME_BIGNOTEJUDGE_DESC"));
		this.list項目リスト.Add(this.iTaikoBigNotesJudge);

		this.iTaikoForceNormalGauge = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_GAME_NORMALGAUGE"), OpenNijiiroRW.ConfigIni.bForceNormalGauge,
			CLangManager.LangInstance.GetString("SETTINGS_GAME_NORMALGAUGE_DESC"));
		this.list項目リスト.Add(this.iTaikoForceNormalGauge);

		this.iTaikoJudgeCountDisp = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_GAME_SCOREDISPLAY"), OpenNijiiroRW.ConfigIni.bJudgeCountDisplay,
			CLangManager.LangInstance.GetString("SETTINGS_GAME_SCOREDISPLAY_DESC"));
		this.list項目リスト.Add(this.iTaikoJudgeCountDisp);

		this.iShowExExtraAnime = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_GAME_EXEXTRAANIME"), OpenNijiiroRW.ConfigIni.ShowExExtraAnime,
			CLangManager.LangInstance.GetString("SETTINGS_GAME_EXEXTRAANIME_DESC"));
		this.list項目リスト.Add(this.iShowExExtraAnime);

		this.TokkunSkipCount = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_TRAINING_SKIPCOUNT"), 1, 99, OpenNijiiroRW.ConfigIni.TokkunSkipMeasures,
			CLangManager.LangInstance.GetString("SETTINGS_TRAINING_SKIPCOUNT_DESC"));
		this.list項目リスト.Add(TokkunSkipCount);

		this.TokkunMashInterval = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_TRAINING_JUMPINTERVAL"), 1, 9999, OpenNijiiroRW.ConfigIni.TokkunMashInterval,
			CLangManager.LangInstance.GetString("SETTINGS_TRAINING_JUMPINTERVAL_DESC"));
		this.list項目リスト.Add(TokkunMashInterval);

		this.iTaikoIgnoreSongUnlockables = new CItemToggle(CLangManager.LangInstance.GetString("SETTINGS_GAME_IGNORESONGUNLOCKABLES"), OpenNijiiroRW.ConfigIni.bIgnoreSongUnlockables,
		...
		this.iControllerDeadzone = new CItemInteger(CLangManager.LangInstance.GetString("SETTINGS_GAME_CONTROLLERDEADZONE"), 10, 90, OpenNijiiroRW.ConfigIni.nControllerDeadzone,
	...
	public void tEnter押下() {
		...
		// Training controls
			...
			if (this.list項目リスト[this.n現在の選択項目] == this.iSystemLanguage) {
				...
				prvFont?.Dispose();
				OpenNijiiroRW.stageConfig.ftフォント?.Dispose();
				OpenNijiiroRW.stageTitle.pfMenuTitle?.Dispose();
				OpenNijiiroRW.stageTitle.pfBoxText?.Dispose();

				prvFont = HPrivateFastFont.tInstantiateMainFont(OpenNijiiroRW.Skin.Config_Font_Scale);
				OpenNijiiroRW.stageConfig.ftフォント = HPrivateFastFont.tInstantiateMainFont((int)OpenNijiiroRW.Skin.Config_Font_Scale_Description, CFontRenderer.FontStyle.Bold);
				OpenNijiiroRW.stageTitle.pfMenuTitle = HPrivateFastFont.tInstantiateMainFont(OpenNijiiroRW.Skin.Title_ModeSelect_Title_Scale[0]);
				OpenNijiiroRW.stageTitle.pfBoxText = HPrivateFastFont.tInstantiateBoxFont(OpenNijiiroRW.Skin.Title_ModeSelect_Title_Scale[1]);

				t項目リストの設定_System(refresh: false);
				OpenNijiiroRW.stageConfig.ReloadMenus();
			}
			// Enter押下後の後処理
			...
			else if (this.list項目リスト[this.n現在の選択項目] == this.iSystemReloadDTX)              // #32081 2013.10.21 yyagi
			{
				...
				OpenNijiiroRW.EnumSongs.StartEnumFromDisk();
				OpenNijiiroRW.EnumSongs.ChangeEnumeratePriority(ThreadPriority.Normal);
			...
			} else if (this.list項目リスト[this.n現在の選択項目] == this.iSystemHardReloadDTX)              // #32081 2013.10.21 yyagi
			{
				...
				OpenNijiiroRW.EnumSongs.StartEnumFromDisk(true);
				OpenNijiiroRW.EnumSongs.ChangeEnumeratePriority(ThreadPriority.Normal);
				OpenNijiiroRW.actEnumSongs.bコマンドでの曲データ取得 = true;
				OpenNijiiroRW.actEnumSongs.Activate();
				OpenNijiiroRW.stageSongSelect.actSongList.ResetSongIndex();
	...
	public override void DeActivate() {
		...
		if (OperatingSystem.IsWindows()) {
			...
			this.iSystemSoundTimerType_initial != this.iSystemSoundTimerType.GetIndex()) {
				...
				OpenNijiiroRW.SoundManager.tInitialize(soundDeviceType,
				...
				OpenNijiiroRW.app.ShowWindowTitle();
	...
	public int Draw(bool b項目リスト側にフォーカスがある) {
		...
		#region [ 項目スクロールの進行 ]
		//-----------------
		long n現在時刻 = OpenNijiiroRW.Timer.NowTimeMs;
		...
		for (int i = 0; i < (OpenNijiiroRW.Skin.Config_ItemBox_Count / 2) - 1; i++)
			nItem = this.t前の項目(nItem);

		for (int i = 0; i < OpenNijiiroRW.Skin.Config_ItemBox_Count; i++)      // n行番号 == 0 がフォーカスされている項目パネル。
		{
			bool centerFlag = i == (OpenNijiiroRW.Skin.Config_ItemBox_Count / 2) - 1;

			#region [ 今まさに画面外に飛びだそうとしている項目パネルは描画しない。]
			//-----------------
			if (((i == 0) && (this.n現在のスクロールカウンタ > 0)) ||       // 上に飛び出そうとしている
				((i == OpenNijiiroRW.Skin.Config_ItemBox_Count - 1) && (this.n現在のスクロールカウンタ < 0)))      // 下に飛び出そうとしている
			{
			...
			int n移動先の行の基本位置 = (this.n現在のスクロールカウンタ <= 0) ? ((i + 1) % OpenNijiiroRW.Skin.Config_ItemBox_Count) : (((i - 1) + OpenNijiiroRW.Skin.Config_ItemBox_Count) % OpenNijiiroRW.Skin.Config_ItemBox_Count);
			int x = OpenNijiiroRW.Skin.Config_ItemBox_X[i] + ((int)((OpenNijiiroRW.Skin.Config_ItemBox_X[n移動先の行の基本位置] - OpenNijiiroRW.Skin.Config_ItemBox_X[i]) * (((double)Math.Abs(this.n現在のスクロールカウンタ)) / 100.0)));
			int y = OpenNijiiroRW.Skin.Config_ItemBox_Y[i] + ((int)((OpenNijiiroRW.Skin.Config_ItemBox_Y[n移動先の行の基本位置] - OpenNijiiroRW.Skin.Config_ItemBox_Y[i]) * (((double)Math.Abs(this.n現在のスクロールカウンタ)) / 100.0)));
			...
			switch (this.list項目リスト[nItem].eパネル種別) {
				...
				case CItemBase.EPanelType.Other:
					if (OpenNijiiroRW.Tx.Config_ItemBox != null)
						OpenNijiiroRW.Tx.Config_ItemBox.t2D描画(x, y);
					break;
			}
			//-----------------
			#endregion
			...
			if (b強調) {
				...
				listMenu[nItem].txParam.t2D描画(x + OpenNijiiroRW.Skin.Config_ItemBox_ItemValue_Font_Offset[0], y + OpenNijiiroRW.Skin.Config_ItemBox_ItemValue_Font_Offset[1]);
			}
			//-----------------
			#endregion
		...
		if (this.b項目リスト側にフォーカスがある && (this.n目標のスクロールカウンタ == 0)) {
			...
			if (this.b要素値にフォーカス中) {
				...
				y_lower = OpenNijiiroRW.Skin.Config_Arrow_Y[1] + this.ct三角矢印アニメ.CurrentValue;
			}
	...
	private void tConfigIniへ記録する_System() {
		...
		OpenNijiiroRW.ConfigIni.bFullScreen = this.iSystemFullscreen.bON;
		OpenNijiiroRW.ConfigIni.bIncludeSubfoldersOnRandomSelect = this.iSystemRandomFromSubBox.bON;

		OpenNijiiroRW.ConfigIni.bEnableVSync = this.iSystemVSyncWait.bON;
		OpenNijiiroRW.ConfigIni.bBufferedInputs = this.iSystemBufferedInput.bON;
		OpenNijiiroRW.InputManager?.SetUseBufferInput(OpenNijiiroRW.ConfigIni.bBufferedInputs);
		OpenNijiiroRW.ConfigIni.bEnableAVI = this.iSystemAVI.bON;
		OpenNijiiroRW.ConfigIni.eClipDispType = (EClipDispType)this.iSystemAVIDisplayMode.n現在選択されている項目番号;
		OpenNijiiroRW.ConfigIni.bEnableBGA = this.iSystemBGA.bON;
		OpenNijiiroRW.ConfigIni.nMsWaitPreviewSoundFromSongSelected = this.iSystemPreviewSoundWait.n現在の値;
		OpenNijiiroRW.ConfigIni.nMsWaitPreviewImageFromSongSelected = this.iSystemPreviewImageWait.n現在の値;
		OpenNijiiroRW.ConfigIni.bDisplayDebugInfo = this.iSystemDebugInfo.bON;
		OpenNijiiroRW.ConfigIni.nBackgroundTransparency = this.iSystemBGAlpha.n現在の値;
		OpenNijiiroRW.ConfigIni.bBGMPlayVoiceSound = this.iSystemBGMSound.bON;
		OpenNijiiroRW.ConfigIni.bDanTowerHide = this.iDanTowerHide.bON;

		OpenNijiiroRW.ConfigIni.ApplySongVol = this.iSystemApplySongVol.bON;
		OpenNijiiroRW.ConfigIni.SoundEffectLevel = this.iSystemSoundEffectLevel.n現在の値;
		OpenNijiiroRW.ConfigIni.VoiceLevel = this.iSystemVoiceLevel.n現在の値;
		OpenNijiiroRW.ConfigIni.SongPreviewLevel = this.iSystemSongPreviewLevel.n現在の値;
		OpenNijiiroRW.ConfigIni.SongPlaybackLevel = this.iSystemSongPlaybackLevel.n現在の値;
		OpenNijiiroRW.ConfigIni.KeyboardSoundLevelIncrement = this.iSystemKeyboardSoundLevelIncrement.n現在の値;
		OpenNijiiroRW.ConfigIni.MusicPreTimeMs = this.MusicPreTimeMs.n現在の値;

		OpenNijiiroRW.ConfigIni.bOutputLogs = this.iLogOutputLog.bON;
		OpenNijiiroRW.ConfigIni.bIsAutoResultCapture = this.iSystemAutoResultCapture.bON;                  // #25399 2011.6.9 yyagi
		OpenNijiiroRW.ConfigIni.SendDiscordPlayingInformation = this.SendDiscordPlayingInformation.bON;

		OpenNijiiroRW.ConfigIni.nRisky = this.iSystemRisky.n現在の値;                                      // #23559 2011.7.27 yyagi

		OpenNijiiroRW.ConfigIni.strSystemSkinSubfolderFullName = skinSubFolders[nSkinIndex];               // #28195 2012.5.2 yyagi
		...
		OpenNijiiroRW.ConfigIni.bUseOSTimer = this.iSystemSoundTimerType.bON;                              // #33689 2014.6.17 yyagi

		OpenNijiiroRW.ConfigIni.bTimeStretch = this.iSystemTimeStretch.bON;                                    // #23664 2013.2.24 yyagi


		OpenNijiiroRW.ConfigIni.sLang = CLangManager.intToLang(this.iSystemLanguage.n現在選択されている項目番号);
		CLangManager.langAttach(OpenNijiiroRW.ConfigIni.sLang);
		OpenNijiiroRW.ConfigIni.ShowChara = this.ShowChara.bON;
		OpenNijiiroRW.ConfigIni.ShowDancer = this.ShowDancer.bON;
		OpenNijiiroRW.ConfigIni.ShowRunner = this.ShowRunner.bON;
		OpenNijiiroRW.ConfigIni.ShowMob = this.ShowMob.bON;
		OpenNijiiroRW.ConfigIni.ShowFooter = this.ShowFooter.bON;
		OpenNijiiroRW.ConfigIni.ShowPuchiChara = this.ShowPuchiChara.bON;

		OpenNijiiroRW.ConfigIni.nPlayerCount = this.iTaikoPlayerCount.n現在の値;
		OpenNijiiroRW.ConfigIni.FastRender = this.FastRender.bON;
		OpenNijiiroRW.ConfigIni.ASyncTextureLoad = this.ASyncTextureLoad.bON;
		OpenNijiiroRW.ConfigIni.SimpleMode = this.SimpleMode.bON;
	...
	private void tConfigIniへ記録する_Drums() {
		...
		OpenNijiiroRW.ConfigIni.bTight = this.iDrumsTight.bON;

		OpenNijiiroRW.ConfigIni.nGlobalOffsetMs = this.iGlobalOffsetMs.n現在の値;
		OpenNijiiroRW.ConfigIni.nControllerDeadzone = this.iControllerDeadzone.n現在の値;
		OpenNijiiroRW.InputManager.Deadzone = OpenNijiiroRW.ConfigIni.nControllerDeadzone / 100.0f;
		OpenNijiiroRW.ConfigIni.bIgnoreSongUnlockables = this.iTaikoIgnoreSongUnlockables.bON;

		OpenNijiiroRW.ConfigIni.nMinDisplayedCombo.Drums = this.iSystemMinComboDrums.n現在の値;
		OpenNijiiroRW.ConfigIni.nRisky = this.iSystemRisky.n現在の値;                      // #23559 2911.7.27 yyagi
		OpenNijiiroRW.ConfigIni.bBranchGuide = this.iTaikoBranchGuide.bON;
		OpenNijiiroRW.ConfigIni.nDefaultCourse = this.iTaikoDefaultCourse.n現在選択されている項目番号;
		OpenNijiiroRW.ConfigIni.nScoreMode = this.iTaikoScoreMode.n現在選択されている項目番号;
		OpenNijiiroRW.ConfigIni.ShinuchiMode = this.ShinuchiMode.bON;
		OpenNijiiroRW.ConfigIni.nBranchAnime = this.iTaikoBranchAnime.n現在選択されている項目番号;
		OpenNijiiroRW.ConfigIni.bNoInfo = this.iTaikoNoInfo.bON;

		OpenNijiiroRW.ConfigIni.eGameMode = (EGame)this.iTaikoGameMode.n現在選択されている項目番号;
		OpenNijiiroRW.ConfigIni.bJudgeCountDisplay = this.iTaikoJudgeCountDisp.bON;
		OpenNijiiroRW.ConfigIni.ShowExExtraAnime = this.iShowExExtraAnime.bON;
		OpenNijiiroRW.ConfigIni.bJudgeBigNotes = this.iTaikoBigNotesJudge.bON;
		OpenNijiiroRW.ConfigIni.bForceNormalGauge = this.iTaikoForceNormalGauge.bON;

		OpenNijiiroRW.ConfigIni.TokkunSkipMeasures = this.TokkunSkipCount.n現在の値;
		OpenNijiiroRW.ConfigIni.TokkunMashInterval = this.TokkunMashInterval.n現在の値;
	}
	//-----------------
	#endregion
}
