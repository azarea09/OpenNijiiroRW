...
using System.Text;
using OpenNijiiroRW.CSongListNodeComparers;
...
internal class CSongs管理 {
							...
							if (dtx.b譜面が存在する[n]) {
								...
								switch (CStrジャンルtoNum.ForAC15(c曲リストノード.songGenre)) {
									case 0:
										...
										break;
									case 1:
										c曲リストノード.ForeColor = OpenNijiiroRW.Skin.SongSelect_ForeColor_Anime;
										c曲リストノード.BackColor = OpenNijiiroRW.Skin.SongSelect_BackColor_Anime;
										break;
									case 2:
										c曲リストノード.ForeColor = OpenNijiiroRW.Skin.SongSelect_ForeColor_VOCALOID;
										c曲リストノード.BackColor = OpenNijiiroRW.Skin.SongSelect_BackColor_VOCALOID;
										break;
									case 3:
										c曲リストノード.ForeColor = OpenNijiiroRW.Skin.SongSelect_ForeColor_Children;
										c曲リストノード.BackColor = OpenNijiiroRW.Skin.SongSelect_BackColor_Children;
										break;
									case 4:
										c曲リストノード.ForeColor = OpenNijiiroRW.Skin.SongSelect_ForeColor_Variety;
										c曲リストノード.BackColor = OpenNijiiroRW.Skin.SongSelect_BackColor_Variety;
										break;
									case 5:
										c曲リストノード.ForeColor = OpenNijiiroRW.Skin.SongSelect_ForeColor_Classic;
										c曲リストノード.BackColor = OpenNijiiroRW.Skin.SongSelect_BackColor_Classic;
										break;
									case 6:
										c曲リストノード.ForeColor = OpenNijiiroRW.Skin.SongSelect_ForeColor_GameMusic;
										c曲リストノード.BackColor = OpenNijiiroRW.Skin.SongSelect_BackColor_GameMusic;
										break;
									case 7:
										c曲リストノード.ForeColor = OpenNijiiroRW.Skin.SongSelect_ForeColor_Namco;
										c曲リストノード.BackColor = OpenNijiiroRW.Skin.SongSelect_BackColor_Namco;
										break;
									default:
										break;
								}
	...
	public void tSongListPostprocessing() {
		...
		Array.Sort(ba);
		OpenNijiiroRW.Skin.strBoxDefSkinSubfolders = ba;
	}
