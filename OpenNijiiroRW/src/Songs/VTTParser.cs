...
using FDK;
using SkiaSharp;
using static OpenNijiiroRW.CTja;
										...
										foreach (string clr in colordata) {
											switch (clr) {
												case "white":
													...
													break;
												case "lime":
													data.ForeColor = OpenNijiiroRW.Skin.Game_Lyric_VTTForeColor[1];
													break;
												case "cyan":
													data.ForeColor = OpenNijiiroRW.Skin.Game_Lyric_VTTForeColor[2];
													break;
												case "red":
													data.ForeColor = OpenNijiiroRW.Skin.Game_Lyric_VTTForeColor[3];
													break;
												case "yellow":
													data.ForeColor = OpenNijiiroRW.Skin.Game_Lyric_VTTForeColor[4];
													break;
												case "magenta":
													data.ForeColor = OpenNijiiroRW.Skin.Game_Lyric_VTTForeColor[5];
													break;
												case "blue":
													data.ForeColor = OpenNijiiroRW.Skin.Game_Lyric_VTTForeColor[6];
													break;
												case "black":
													data.ForeColor = OpenNijiiroRW.Skin.Game_Lyric_VTTForeColor[7];
													break;
												case "bg_white":
													data.BackColor = OpenNijiiroRW.Skin.Game_Lyric_VTTBackColor[0];
													break;
												case "bg_lime":
													data.BackColor = OpenNijiiroRW.Skin.Game_Lyric_VTTBackColor[1];
													break;
												case "bg_cyan":
													data.BackColor = OpenNijiiroRW.Skin.Game_Lyric_VTTBackColor[2];
													break;
												case "bg_red":
													data.BackColor = OpenNijiiroRW.Skin.Game_Lyric_VTTBackColor[3];
													break;
												case "bg_yellow":
													data.BackColor = OpenNijiiroRW.Skin.Game_Lyric_VTTBackColor[4];
													break;
												case "bg_magenta":
													data.BackColor = OpenNijiiroRW.Skin.Game_Lyric_VTTBackColor[5];
													break;
												case "bg_blue":
													data.BackColor = OpenNijiiroRW.Skin.Game_Lyric_VTTBackColor[6];
													break;
												case "bg_black":
