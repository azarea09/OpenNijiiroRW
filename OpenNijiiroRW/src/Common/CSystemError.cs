	...
	public void LoadError(Errno errno)
	{
		...
		switch (errno)
		{
			...
			case Errno.ENO_UNKNOWN:
				{
					ErrorMessage += "Please try restarting OpenNijiiroRW.";
					break;
				}
			...
			case Errno.ENO_SKINNOTFOUND:
				{
					...
					ErrorMessage += "If you have not installed a skin, please do so through the OpenNijiiroRW Hub (Skins tab).\n";
					ErrorMessage += "If this does not resolve the issue, please try updating your skins through the OpenNijiiroRW Hub.\n";
					break;
				}
			...
			case Errno.ENO_SONGLISTINITFAILED:
				{
					...
					ErrorMessage += "Please try removing the songlist.db file within your OpenNijiiroRW folder.";
					break;
				}
		...
		ErrorMessage += "\nIf the error persists, please contact us through the links provided on the OpenNijiiroRW Hub.";
	}
