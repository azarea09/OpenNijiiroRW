...

			{
...
#endif
				{
					...
					if (OperatingSystem.IsWindows())
						...
						throw new PlatformNotSupportedException("OpenNijiiroRW does not support this OS.");
					...
					switch (RuntimeInformation.ProcessArchitecture) {
						...
						case Architecture.Arm64:
							...
							break;
						default:
							throw new PlatformNotSupportedException($"OpenNijiiroRW does not support this architecture. ({RuntimeInformation.ProcessArchitecture})");
					}
					...
					using (var mania = new OpenNijiiroRW())
						mania.Run();
